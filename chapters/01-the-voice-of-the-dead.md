# 01 — The Voice of the Dead

## Chapter focus

The opening chapter establishes the world from which recorded pop emerged: copyright and commercial songwriting, sheet music, music hall and vaudeville, star performers, the phonograph/gramophone, and finally the radical idea that a performance could survive the performer.

The playlist therefore should not sound like a generic “music before 1900” anthology. It should make audible the transition from **song as composition** to **performance as reproducible object**.
...
| 11 | DOGGETT | Harry Lauder | I Love a Lassie | Another major star whose familiar persona itself became a commercial draw. | Exact recording/link to verify |
| 12 | CONTEXT | Dan W. Quinn | The Band Played On | American commercial recording culture and the rise of prolific specialist recording singers. | Exact recording/link to verify |
| 13 | CONTEXT | Len Spencer | A Hot Time in the Old Town | Vaudeville, publishing and recording beginning to form one commercial system. | Exact recording/link to verify |
| 14 | CONTEXT | Arthur Collins | The Preacher and the Bear | Important early recording artist whose repertoire also exposes the racial caricature built into much period entertainment. | Exact recording/link to verify |
| 15 | CONTEXT | Billy Golden | Turkey in the Straw | Representative of comic performance, familiar tunes and novelty in the talking-machine market. | Exact recording/link to verify |
| 16 | CONTEXT | Sousa's Band | The Stars and Stripes Forever | Reminds us how central instrumental bands were to early recording catalogues. | Exact recording/link to verify |
| 17 | CONTEXT | Sousa's Band | Washington Post March | Optional second band recording; may be cut if the finished playlist needs tightening. | Exact recording/link to verify |
| 18 | PROXY | Franz Lehár / period orchestra | The Merry Widow Waltz | Doggett discusses the exceptional reach of *The Merry Widow* beyond the theatre; an early c.1907–10 recording is preferred. | Period recording to identify |
...
For early material, matching only artist + title is not sufficient. We should record, where possible:

- recording year/date
- label/catalogue information when useful
- whether the upload is an original-period recording, later re-recording or modern recreation
